...
import 'package:studenda_mobile/widgets/journal/journal_attendance_screen.dart';

final tasks = <Task>[
  Task(0, "Лабораторная работа №1", Subject(0, "qqq", "qq", "QWErty"), 5),
  Task(1, "Практическое задание №2", Subject(0, "qqq", "qq", "QWErty"), 5),
  Task(2, "Курсовая работа", Subject(0, "qqq", "qq", "QWErty"), 4),
  Task(3, "Лабораторная работа №1", Subject(0, "qqq", "qq", "QWErty"), 3),
  Task(4, "Лабораторная работа №1", Subject(0, "qqq", "qq", "QWErty"), 3),
  Task(5, "Лабораторная работа №1", Subject(0, "qqq", "qq", "QWErty"), 4),
  Task(6, "Лабораторная работа №1", Subject(0, "qqq", "qq", "QWErty"), 5),
];
...
class _TaskItemWidget extends StatelessWidget {
  ...
  const _TaskItemWidget({super.key, required this.task});
