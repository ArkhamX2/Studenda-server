...
{
    public static readonly BindableProperty NotificationNameProperty = BindableProperty.Create(nameof(NotificationName), typeof(string), typeof(NotificationComponent),
    ...
    public static readonly BindableProperty NotificationDateProperty = BindableProperty.Create(nameof(NotificationDate), typeof(string), typeof(NotificationComponent),
        propertyChanged: (bindable, oldValue, newValue) =>
        {
            var control = (NotificationComponent)bindable;
