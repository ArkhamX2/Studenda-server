...
///     Тип оценивания.
/// </summary>
public class AssessmentType : IdentifiableEntity
{
    /*                   __ _                       _   _
    ...
    internal class Configuration(ContextConfiguration configuration) : Configuration<AssessmentType>(configuration)
    {
        /// <summary>
